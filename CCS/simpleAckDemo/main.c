...
void main(void) {
  ...
  wispData.epcBuf[3] = 0x33;			// Unused data field
  wispData.epcBuf[4] = 0x44;			// Unused data field
  wispData.epcBuf[5] = 0x55;			// Unused data field
  wispData.epcBuf[6] = 0x66;			// Unused data field
  wispData.epcBuf[7] = 0x77;		// Unused data field
  wispData.epcBuf[8] = 0x88;		// Unused data field
