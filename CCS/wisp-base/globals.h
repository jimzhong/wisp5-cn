...
#ifndef WISP_BASE_CN_GLOBALS_H_
#define WISP_BASE_CN_GLOBALS_H_
...
#define CMDBUFF_SIZE    (30)                                            /* Buffer size for reader command */
...
#define RFID_SEED       (0x1834)    //change this to change the RN16 selection behavior. if using multiple tags make sure to put a
                                    //different value on each one!!
...
#define RTCAL_MAX	(700)
#define RTCAL_MIN	(470)
#define TRCAL_MIN	(500)
...
#define TX_TIMING_QUERY (110)
#define TX_TIMING_ACK (100)
#define TX_TIMING_QR (260)
#define TX_TIMING_QA (190)

//#define TX_TIMING_QUERY (24)/*53.5-60us (depends on which Q value is loaded). */
//#define TX_TIMING_ACK   (60)/*60.0us*/  //(14,58.6us)
