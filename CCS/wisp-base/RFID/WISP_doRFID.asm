...
;* 	@details	This module prepares CRC16 for EPC, and enables falling edge interrupt on RX pin.
;*	When it wakes up, it decodes the command and call the corresponding handler.
;*
